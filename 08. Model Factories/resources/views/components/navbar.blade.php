<div>
    <nav class="bg-gray-800" x-data="{ isOpen: false }">
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <!-- component nav link, mengirimkan atributtes yang akan digunakan oleh $attribute dan $active-->
        ...
        <div x-show="isOpen" x-transition:enter="transition ease-out duration-200 transform"
            ...
            x-transition:leave-end="opacity-0 translate-y-[-100%]" class="md:hidden" id="mobile-menu">
